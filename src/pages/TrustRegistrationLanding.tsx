...
import { TrustRegistrationContentSections, TRUST_FAQ_ITEMS } from './ngo/TrustRegistrationContentSections';
...
const TOC_LINKS = [
  ...
  { id: 'what-is-ngo-registration', label: 'What is Trust' },
...
const RELATED_SERVICES = [
  ...
  },
  {
    ...
    desc: 'Income Tax exemptions for trusts and 50% donor tax deduction certificates.',
    price: '₹5,999/-'
  },
  {
...
export const TrustRegistrationLanding: React.FC<TrustRegistrationLandingProps> = ({
  ...
  const [selectedPackageTier, setSelectedPackageTier] = useState('Trust Registration (₹2,999 + Govt Fee)');
  const [captchaInput, setCaptchaInput] = useState('');
  const [captchaCode, setCaptchaCode] = useState('8T4K1');
  ...
  const handleShare = (platform: string) => {
    ...
    const title = 'Trust Registration starting at ₹2999/- only + Govt. Fee! | Akshay B2B Solutions';
    if (platform === 'facebook') {
      ...
      window.open(`mailto:?subject=${encodeURIComponent(title)}&body=${encodeURIComponent('Check out Trust Registration on Akshay B2B Solutions: ' + url)}`, '_blank');
    }
  };
    ...
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-blue-900 selection:text-white flex flex-col antialiased">
      ...
      <div className="bg-slate-100 border-b border-slate-200 py-2.5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-xs text-slate-600 flex items-center gap-2">
          ...
          <span>»</span>
          <span className="text-blue-900 font-bold">Trust Registration</span>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-7 space-y-6">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/15 border border-blue-400/30 text-blue-300 text-xs font-semibold">
                ...
                <span>Indian Trusts Act, 1882 | Public Charitable Trusts • Schools • Hospitals</span>
              </div>
              ...
              <div className="p-3.5 rounded-xl bg-gradient-to-r from-blue-500/20 via-blue-600/15 to-transparent border-l-4 border-blue-400 text-blue-200 font-bold text-sm sm:text-base">
                Obtain Trust Registration starting at ₹2999/- only + Govt. Fee!
              </div>

              <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
                A Trust (specifically a Public Charitable Trust) is a legal entity created by a settler through a registered Trust Deed under the Indian Trusts Act, 1882 (or state-specific trust laws such as the Bombay Public Trusts Act, 1950), in which property or assets are transferred to trustees to manage for the benefit of a specified public or charitable purpose. It is ideal for families, individuals, and philanthropists looking to establish long-term educational institutions, healthcare facilities, religious bodies, or social welfare organizations, offering simple creation, flexibility in trustee appointment, and eligibility for tax exemptions under 12A/80G.
              </p>
              ...
              <div className="grid grid-cols-2 gap-3 pt-2 text-xs sm:text-sm text-slate-200">
                <div className="flex items-center gap-2">
                  ...
                  <span>Custom Trust Deed Drafting by Advocates</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-blue-400 flex-shrink-0" />
                  <span>Sub-Registrar Presentation Guidance</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-blue-400 flex-shrink-0" />
                ...
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-blue-400 flex-shrink-0" />
                  <span>Zero Hidden Surcharges Guaranteed</span>
                </div>
              </div>
            </div>
                ...
                <div className="border-b border-slate-100 pb-4 mb-5 flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-slate-500 mt-0.5">
                      Fast-track Trust Registration with senior non-profit legal counsel
                    </p>
                  </div>
                ...
                {formSubmitted ? (
                  <div className="py-8 text-center space-y-4">
                    ...
                    <p className="text-xs text-slate-600 max-w-sm mx-auto">
                      Thank you, <strong>{applicantName || 'Valued Founder'}</strong>. Our Trust legal specialists will call you shortly on <strong>{applicantMobile}</strong>.
                    </p>
                    <button
                      onClick={() => {
                  ...
                  <form onSubmit={handleFormSubmit} className="space-y-4 text-xs">
                    ...
                    {formStep === 2 && (
                      <div className="space-y-3.5">
                        <div>
                          <label className="block font-bold text-slate-700 mb-1">
                            Trust Category <span className="text-rose-500">*</span>
                          </label>
                          <select
                            value={businessType}
                        ...
                        <div>
                          <label className="block font-bold text-slate-700 mb-1">
                            Primary Focus / Charitable Sector <span className="text-rose-500">*</span>
                          </label>
                          <select
                        ...
                        <div className="p-3 bg-blue-50 rounded-xl border border-blue-100 text-slate-700 text-xs">
                          <p className="font-semibold text-blue-900 mb-0.5">Comprehensive Trust Deed Drafting</p>
                          Our legal team crafts customized Trust Deeds reflecting your succession principles, corpus rules, and Section 12A/80G compliance mandates.
                        </div>
                      </div>
                    )}
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 flex-1">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-9 space-y-12">
            ...
            <TrustRegistrationContentSections
            ...
            <section id="packages" className="scroll-mt-28 space-y-4 pt-4">
              ...
              <p className="text-xs text-slate-600">
                Guaranteed flat professional fee with zero hidden legal surcharges or surprise markups.
              </p>
              ...
              <div className="rounded-3xl border-2 border-blue-600 bg-white p-6 sm:p-8 shadow-xl relative overflow-hidden">
                <div className="absolute top-0 right-0 bg-blue-800 text-white text-[11px] font-black uppercase px-4 py-1 rounded-bl-xl tracking-wider">
                  Complete Public Trust Formation
                </div>
                ...
                <div className="max-w-2xl">
                  ...
                  <p className="text-xs sm:text-sm text-slate-600 mt-1">
                    Complete Public Charitable Trust registration handled end-to-end by our experts, ideal for philanthropic initiatives, schools, and hospitals.
                  </p>
                  ...
                  <div className="mt-8 pt-6 border-t border-slate-100">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 text-xs text-slate-700">
                      {[
                        'Trust Deed Drafting',
                        'Stamp Duty Guidance',
                        'Sub-Registrar Appointment & Registration Support',
                        'PAN & TAN Application',
                ...
                {[
                  {
                    ...
                    desc: 'Senior corporate attorneys and NGO legal specialists drafting your trust deed directly.'
                  },
                  {
                    icon: <Clock className="w-5 h-5 text-blue-800" />,
                    title: 'Time-Saving Process',
                    desc: 'Zero paperwork hassles; rapid Sub-Registrar appointment scheduling and deed registration.'
                  },
                  {
                  ...
                  },
                  {
                    ...
                    desc: 'Over 18,500 non-profits, trusts, and foundations incorporated across India.'
                  },
                  {
                    icon: <Zap className="w-5 h-5 text-blue-800" />,
                    title: 'Compliance Alerts',
                    desc: 'Automated reminders for annual ITR-7 filings, 10BD submissions, and audit reports.'
                  },
                  {
            ...
            <div className="rounded-3xl bg-gradient-to-r from-blue-950 via-slate-900 to-slate-900 text-white p-6 sm:p-8 flex flex-col sm:flex-row items-center justify-between gap-6 shadow-xl">
              <div className="space-y-1 text-center sm:text-left">
                <h3 className="text-lg sm:text-xl font-black">
                  Need 1-on-1 Guidance from a Senior Trust Advocate?
                </h3>
                <p className="text-xs text-slate-300">
                  Book a confidential 30-minute consultation to structure your Trust Deed, succession rules, and 12A/80G tax exemptions.
                </p>
              </div>
              <button
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-base sm:text-lg font-black">
                    Manage Your Trust &amp; Tax Filings from Your Smartphone
                  </h3>
                  <p className="text-xs text-slate-400 mt-0.5">
                    Download the Akshay B2B Android app to track Sub-Registrar appointments, upload trustee documents, and access CA support on the go.
                  </p>
                </div>
              </div>
              <a
