...
import { SocietyRegistrationContentSections, SOCIETY_FAQ_ITEMS } from './ngo/SocietyRegistrationContentSections';
...
const TOC_LINKS = [
  ...
  { id: 'what-is-ngo-registration', label: 'What is Society' },
...
const RELATED_SERVICES = [
  ...
  },
  {
    ...
    desc: 'Mandatory NITI Aayog portal enrollment for accessing government grants & schemes.',
    price: '₹1,499/-'
  },
  {
    title: 'Trust Registration',
    desc: 'Public charitable trust formation under Indian Trusts Act with perpetual succession.',
    price: '₹2,999/-'
  },
  {
    title: '12A & 80G Registration',
    desc: 'Income Tax exemptions for societies and 50% donor tax deduction certificates.',
    price: '₹5,999/-'
  },
  {
...
export const SocietyRegistrationLanding: React.FC<SocietyRegistrationLandingProps> = ({
  ...
  const [selectedPackageTier, setSelectedPackageTier] = useState('Society Registration (₹2,999 + Govt Fee)');
  const [captchaInput, setCaptchaInput] = useState('');
  const [captchaCode, setCaptchaCode] = useState('7B2K9');
  ...
  const handleShare = (platform: string) => {
    ...
    const title = 'Society Registration starting at ₹2999/- only + Govt. Fee! | Akshay B2B Solutions';
    if (platform === 'facebook') {
      ...
      window.open(`mailto:?subject=${encodeURIComponent(title)}&body=${encodeURIComponent('Check out Society Registration on Akshay B2B Solutions: ' + url)}`, '_blank');
    }
  };
    ...
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-blue-900 selection:text-white flex flex-col antialiased">
      ...
      <div className="bg-slate-100 border-b border-slate-200 py-2.5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-xs text-slate-600 flex items-center gap-2">
          ...
          <span>»</span>
          <span className="text-blue-900 font-bold">Society Registration</span>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-7 space-y-6">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/15 border border-blue-400/30 text-blue-300 text-xs font-semibold">
                ...
                <span>Societies Registration Act, 1860 | Community • Cultural • Educational</span>
              </div>
              ...
              <div className="p-3.5 rounded-xl bg-gradient-to-r from-blue-500/20 via-blue-600/15 to-transparent border-l-4 border-blue-400 text-blue-200 font-bold text-sm sm:text-base">
                Obtain Society Registration starting at ₹2999/- only + Govt. Fee!
              </div>

              <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
                A Society is a voluntary association of seven or more persons registered under the Societies Registration Act, 1860, formed to promote literary, scientific, charitable, cultural, educational, or sports-related objectives. It is governed by a Memorandum of Association and Rules &amp; Regulations that define its objectives and internal governance, and is managed by a Governing Body/Executive Committee elected by its members. Societies are commonly used by community groups, welfare associations, and educational or cultural institutions, offering legal recognition, the ability to hold property, and eligibility for grants and tax exemptions.
              </p>
              ...
              <div className="grid grid-cols-2 gap-3 pt-2 text-xs sm:text-sm text-slate-200">
                <div className="flex items-center gap-2">
                  ...
                  <span>State &amp; National Society Drafting</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-blue-400 flex-shrink-0" />
                  <span>By-laws &amp; MOA Tailored by Advocates</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-blue-400 flex-shrink-0" />
                  <span>PAN &amp; TAN Allotment Assistance</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-blue-400 flex-shrink-0" />
                ...
                <div className="border-b border-slate-100 pb-4 mb-5 flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-slate-500 mt-0.5">
                      Fast-track Society Registration with experienced non-profit legal counsel
                    </p>
                  </div>
                ...
                {formSubmitted ? (
                  <div className="py-8 text-center space-y-4">
                    ...
                    <p className="text-xs text-slate-600 max-w-sm mx-auto">
                      Thank you, <strong>{applicantName || 'Valued Member'}</strong>. Our Society Registration legal team will call you shortly on <strong>{applicantMobile}</strong>.
                    </p>
                    <button
                      onClick={() => {
                  ...
                  <form onSubmit={handleFormSubmit} className="space-y-4 text-xs">
                    ...
                    {formStep === 2 && (
                      <div className="space-y-3.5">
                        <div>
                          <label className="block font-bold text-slate-700 mb-1">
                            Society Category <span className="text-rose-500">*</span>
                          </label>
                          <select
                            value={businessType}
                        ...
                        <div>
                          <label className="block font-bold text-slate-700 mb-1">
                            Primary Cause / Sector <span className="text-rose-500">*</span>
                          </label>
                          <select
                        ...
                        <div className="p-3 bg-blue-50 rounded-xl border border-blue-100 text-slate-700 text-xs">
                          <p className="font-semibold text-blue-900 mb-0.5">Custom By-law &amp; MOA Drafting</p>
                          Our legal specialists draft compliant Memorandum of Association and Rules &amp; Regulations tailored to your state's Registrar requirements.
                        </div>
                      </div>
                    )}
                    ...
                    {formStep === 3 && (
                      <div className="space-y-3.5">
                        <div>
                          <label className="block font-bold text-slate-700 mb-1">
                            President / Secretary PAN (Optional)
                          </label>
                          <input
                            type="text"
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 flex-1">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-9 space-y-12">
            ...
            <SocietyRegistrationContentSections
            ...
            <section id="packages" className="scroll-mt-28 space-y-4 pt-4">
              ...
              <p className="text-xs text-slate-600">
                Guaranteed flat professional fee with zero hidden surcharges or surprise legal markups.
              </p>
              ...
              <div className="rounded-3xl border-2 border-blue-600 bg-white p-6 sm:p-8 shadow-xl relative overflow-hidden">
                ...
                <div className="max-w-2xl">
                  ...
                  <p className="text-xs sm:text-sm text-slate-600 mt-1">
                    Complete Society registration handled end-to-end by our experts, ideal for community groups, welfare associations, and educational/cultural institutions.
                  </p>
                  ...
                  <div className="mt-8 pt-6 border-t border-slate-100">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 text-xs text-slate-700">
                      {[
                        ...
                        'Memorandum of Association & Rules Drafting',
                        'Certificate of Registration',
                        'PAN & TAN Application',
                        'Guidance on 12A & 80G Eligibility',
                        'Timely Service',
                ...
                {[
                  {
                    ...
                    desc: 'Senior corporate attorneys and NGO legal specialists handling your society registration directly.'
                  },
                  {
                  ...
                  },
                  {
                    ...
                    desc: 'Automated reminders for annual ROS returns, AGM filings, 10BD submissions, and audit filings.'
                  },
                  {
                    icon: <Lock className="w-5 h-5 text-blue-800" />,
                    title: 'Secure and Confidential',
                    desc: 'Bank-grade 256-bit encryption for all founder KYC and society documents.'
                  }
                ].map((card, idx) => (
                  <div
                    key={idx}
            ...
            <div className="rounded-3xl bg-gradient-to-r from-blue-950 via-slate-900 to-slate-900 text-white p-6 sm:p-8 flex flex-col sm:flex-row items-center justify-between gap-6 shadow-xl">
              <div className="space-y-1 text-center sm:text-left">
                <h3 className="text-lg sm:text-xl font-black">
                  Need 1-on-1 Guidance from a Senior Non-Profit Advocate?
                </h3>
                <p className="text-xs text-slate-300">
                  Book a confidential 30-minute consultation to structure your Society MOA, By-laws, and 12A/80G tax exemptions.
                </p>
              </div>
              <button
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-base sm:text-lg font-black">
                    Manage Your Society &amp; Compliance Filings from Your Smartphone
                  </h3>
                  <p className="text-xs text-slate-400 mt-0.5">
                    Download the Akshay B2B Android app to track registrar filings, upload member records, and access CA support on the go.
                  </p>
                </div>
              </div>
              <a
