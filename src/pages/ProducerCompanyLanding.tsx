...
export const ProducerCompanyLanding: React.FC<ProducerCompanyLandingProps> = ({
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-emerald-800 selection:text-white flex flex-col antialiased">
      ...
      <div className="bg-slate-100 border-b border-slate-200 py-2.5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-xs text-slate-600 flex items-center gap-2">
          <button
            ...
            className="hover:text-emerald-800 font-semibold cursor-pointer"
          >
            Home
          </button>
          <span>»</span>
          ...
          <span>»</span>
          <span className="text-emerald-800 font-bold">Producer Company Registration</span>
        </div>
      </div>

      {/* 4. Hero Section & 7. Lead Capture Form */}
      <section className="relative bg-gradient-to-br from-slate-900 via-slate-900 to-emerald-950 text-white pt-10 pb-16 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              {/* One-line price hook */}
              <div className="p-3.5 rounded-xl bg-gradient-to-r from-emerald-500/20 via-emerald-600/15 to-transparent border-l-4 border-emerald-400 text-emerald-200 font-bold text-sm sm:text-base">
                  ...
                  <form onSubmit={handleFormSubmit} className="space-y-4 text-xs">
                      ...
                      <div className="space-y-3.5">
                        <div>
                          ...
                          <select
                            ...
                            className="w-full px-3 py-2.5 rounded-xl border border-slate-300 focus:ring-2 focus:ring-emerald-600 focus:border-transparent text-xs bg-white text-slate-800"
                            required
                          >
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className="w-full px-3 py-2.5 rounded-xl border border-slate-300 focus:ring-2 focus:ring-emerald-600 focus:border-transparent text-xs"
                            required
                          />
                        </div>
                    ...
                    {formStep === 2 && (
                      <div className="space-y-3.5">
                        ...
                        <div className="p-3 bg-emerald-50 rounded-xl border border-emerald-100 text-slate-700 text-xs">
                          <p className="font-semibold text-emerald-900 mb-0.5">Primary Producer Status</p>
                      ...
                      <div className="space-y-3.5">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full px-3 py-2.5 rounded-xl border border-slate-300 focus:ring-2 focus:ring-emerald-600 focus:border-transparent text-xs uppercase"
                          />
                        </div>
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-2">
                            <div className="px-3.5 py-2 bg-slate-900 text-emerald-400 font-mono font-black text-sm tracking-widest rounded-xl select-none">
                              {captchaCode}
                            </div>
                            <button
                              type="button"
                            ...
                            <input
                              ...
                              className="flex-1 px-3 py-2.5 rounded-xl border border-slate-300 focus:ring-2 focus:ring-emerald-600 focus:border-transparent text-xs uppercase font-mono"
                              required
                            />
                          </div>
                        </div>
                    ...
                    <div className="pt-2 flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="flex-1 py-3 px-4 rounded-xl bg-emerald-800 hover:bg-emerald-900 text-white font-black text-xs uppercase tracking-wider shadow-md transition-all active:scale-95 flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
                      >
                        {isSubmitting ? (
      ...
      <section className="bg-emerald-900 text-white py-5 border-y border-emerald-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-3 gap-4 text-center divide-x divide-emerald-800">
            <div className="px-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="bg-white rounded-2xl p-4 border border-slate-200 shadow-xs">
                ...
                {TOC_LINKS.map((item) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {isActive && (
                        <span className="w-1.5 h-1.5 rounded-full bg-emerald-800 flex-shrink-0 ml-1" />
                      )}
                    </button>
                  );
                })}
              ...
              <div className="mt-4 pt-3 border-t border-slate-100">
                <button
                  ...
                  className="w-full py-2 px-3 rounded-xl bg-emerald-800 hover:bg-emerald-900 text-white font-bold text-xs flex items-center justify-center gap-1.5 shadow-xs transition-colors cursor-pointer"
                >
          ...
          <div className="lg:col-span-9 space-y-12">
            ...
            <section id="packages" className="scroll-mt-28 space-y-4 pt-4">
              ...
              {/* Single Package Card */}
              <div className="rounded-3xl border-2 border-emerald-600 bg-white p-6 sm:p-8 shadow-xl relative overflow-hidden">
                <div className="absolute top-0 right-0 bg-emerald-700 text-white text-[11px] font-black uppercase px-4 py-1 rounded-bl-xl tracking-wider">
                ...
                <div className="max-w-2xl">
                  ...
                  <div className="mt-6">
                    <button
                      onClick={scrollToLeadForm}
                      className="w-full sm:w-auto px-8 py-3.5 rounded-xl bg-emerald-800 hover:bg-emerald-900 text-white font-black text-sm shadow-md transition-transform active:scale-95 flex items-center justify-center gap-2 cursor-pointer"
                    >
                      <span>Get Started</span>
            ...
            <div className="rounded-3xl bg-gradient-to-r from-emerald-900 via-slate-900 to-slate-900 text-white p-6 sm:p-8 flex flex-col sm:flex-row items-center justify-between gap-6 shadow-xl">
              ...
              <button
                ...
                className="px-6 py-3 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-black text-xs uppercase tracking-wider shadow-md transition-colors flex-shrink-0 cursor-pointer"
              >
                Book Appointment
              </button>
            </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 pt-1">
                {RELATED_SERVICES.map((srv, idx) => (
                  <div
                    ...
                    className="p-3.5 rounded-2xl bg-white border border-slate-200 hover:border-emerald-500 hover:shadow-md transition-all cursor-pointer flex flex-col justify-between group"
                  >
                    <div>
                    ...
                    <div className="mt-3 flex items-center gap-1 text-[11px] font-bold text-emerald-800 group-hover:underline">
            ...
            <div className="rounded-3xl bg-slate-900 text-white p-6 sm:p-8 flex flex-col sm:flex-row items-center justify-between gap-6 border border-slate-800">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="px-5 py-2.5 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-bold text-xs tracking-wider flex items-center gap-1.5 flex-shrink-0 transition-colors"
              >
