...
import { CsrOneRegistrationContentSections, CSR1_FAQ_ITEMS } from './ngo/CsrOneRegistrationContentSections';

interface CsrOneRegistrationLandingProps {
  onBackToHome: () => void;
...
const TOC_LINKS = [
  ...
  { id: 'what-is-ngo-registration', label: 'What is CSR-1' },
...
const RELATED_SERVICES = [
  ...
  },
  {
    ...
    desc: 'Mandatory NITI Aayog portal enrollment for government grants and CSR funding.',
    price: '₹1,499/-'
  },
  {
  ...
  },
  {
    ...
    desc: 'Income Tax exemptions for NGOs and 50% donor tax deduction certificates.',
    price: '₹5,999/-'
  },
  {
    title: 'Darpan Registration',
...
export const CsrOneRegistrationLanding: React.FC<CsrOneRegistrationLandingProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
  ...
  const [selectedPackageTier, setSelectedPackageTier] = useState('CSR 1 Registration (₹2,499 + Govt Fee)');
  const [captchaInput, setCaptchaInput] = useState('');
  const [captchaCode, setCaptchaCode] = useState('6C8R1');
  ...
  const handleShare = (platform: string) => {
    ...
    const title = 'CSR 1 Registration starting at ₹2499/- only + Govt. Fee! | Akshay B2B Solutions';
    if (platform === 'facebook') {
      ...
      window.open(`mailto:?subject=${encodeURIComponent(title)}&body=${encodeURIComponent('Check out CSR 1 Registration on Akshay B2B Solutions: ' + url)}`, '_blank');
    }
  };
    ...
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-blue-900 selection:text-white flex flex-col antialiased">
      ...
      <div className="bg-slate-100 border-b border-slate-200 py-2.5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-xs text-slate-600 flex items-center gap-2">
          ...
          <span>»</span>
          <span className="text-blue-900 font-bold">CSR 1 Registration</span>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-7 space-y-6">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/15 border border-blue-400/30 text-blue-300 text-xs font-semibold">
                ...
                <span>Ministry of Corporate Affairs | Mandatory for Corporate CSR Grants</span>
              </div>
              ...
              <div className="p-3.5 rounded-xl bg-gradient-to-r from-blue-500/20 via-blue-600/15 to-transparent border-l-4 border-blue-400 text-blue-200 font-bold text-sm sm:text-base">
                Obtain CSR 1 Registration starting at ₹2499/- only + Govt. Fee!
              </div>

              <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
                Form CSR-1 is an electronic form filed on the MCA (Ministry of Corporate Affairs) portal under Section 135 of the Companies Act, 2013 and the Companies (Corporate Social Responsibility Policy) Rules, 2014, through which an NGO (Trust, Society, or Section 8 Company) registers itself to become legally eligible to receive Corporate Social Responsibility (CSR) funds from companies. Upon successful verification of the NGO's 12A/80G status, NITI Aayog Darpan ID, and digitally signed submission by a practicing professional (CA/CS/CMA), a unique CSR Registration Number is generated, without which no company can legally disburse CSR funds to the NGO.
              </p>
              ...
              <div className="grid grid-cols-2 gap-3 pt-2 text-xs sm:text-sm text-slate-200">
                <div className="flex items-center gap-2">
                  ...
                  <span>MCA V3 Portal Electronic Filing</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-blue-400 flex-shrink-0" />
                  <span>Practicing CA/CS Certification Included</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-blue-400 flex-shrink-0" />
                  <span>Instant CSR Registration Number (STP)</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-blue-400 flex-shrink-0" />
                ...
                <div className="border-b border-slate-100 pb-4 mb-5 flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-slate-500 mt-0.5">
                      Fast-track Form CSR-1 with practicing Chartered Accountants &amp; Company Secretaries
                    </p>
                  </div>
                ...
                {formSubmitted ? (
                  <div className="py-8 text-center space-y-4">
                    ...
                    <p className="text-xs text-slate-600 max-w-sm mx-auto">
                      Thank you, <strong>{applicantName || 'Valued Non-Profit Leader'}</strong>. Our CSR compliance team will call you shortly on <strong>{applicantMobile}</strong>.
                    </p>
                    <button
                      onClick={() => {
                  ...
                  <form onSubmit={handleFormSubmit} className="space-y-4 text-xs">
                    ...
                    {formStep === 2 && (
                      <div className="space-y-3.5">
                        <div>
                          <label className="block font-bold text-slate-700 mb-1">
                            Implementing Entity Category <span className="text-rose-500">*</span>
                          </label>
                          <select
                            value={businessType}
                        ...
                        <div>
                          <label className="block font-bold text-slate-700 mb-1">
                            Primary CSR Focus (Schedule VII) <span className="text-rose-500">*</span>
                          </label>
                          <select
                        ...
                        <div className="p-3 bg-blue-50 rounded-xl border border-blue-100 text-slate-700 text-xs">
                          <p className="font-semibold text-blue-900 mb-0.5">Practicing CA/CS Certification Included</p>
                          Our in-house practicing professionals review your 12A/80G and Darpan credentials and affix their digital signature directly on Form CSR-1.
                        </div>
                      </div>
                    )}
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 flex-1">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-9 space-y-12">
            ...
            <CsrOneRegistrationContentSections
            ...
            <section id="packages" className="scroll-mt-28 space-y-4 pt-4">
              ...
              <p className="text-xs text-slate-600">
                Guaranteed flat professional fee with CA/CS practicing professional certification included.
              </p>
              ...
              <div className="rounded-3xl border-2 border-blue-600 bg-white p-6 sm:p-8 shadow-xl relative overflow-hidden">
                ...
                <div className="max-w-2xl">
                  ...
                  <p className="text-xs sm:text-sm text-slate-600 mt-1">
                    Complete Form CSR-1 registration filed on the MCA portal with practicing professional certification, essential for receiving corporate CSR funds.
                  </p>
                  ...
                  <div className="mt-8 pt-6 border-t border-slate-100">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 text-xs text-slate-700">
                      {[
                        'Pre-requisite Verification (12A/80G/Darpan)',
                        'Form CSR-1 Drafting & Filing',
                        'Practicing Professional Certification (CA/CS)',
                        'Unique CSR Registration Number Generation',
                        'Timely Service',
                ...
                {[
                  {
                    ...
                    desc: 'Practicing Chartered Accountants & Company Secretaries managing your CSR-1 filing directly.'
                  },
                  {
                    icon: <Clock className="w-5 h-5 text-blue-800" />,
                    title: 'Time-Saving Process',
                    desc: 'Zero paperwork hassles; 100% digital MCA V3 processing with rapid STP generation.'
                  },
                  {
                  ...
                  },
                  {
                    ...
                    desc: 'Automated reminders for annual CSR reporting, utilization certificate submissions, and 10BD filings.'
                  },
                  {
                    icon: <Lock className="w-5 h-5 text-blue-800" />,
                    title: 'Secure and Confidential',
                    desc: 'Bank-grade 256-bit encryption for all founder KYC and MCA portal documents.'
                  }
                ].map((card, idx) => (
                  <div
                    key={idx}
            ...
            <div className="rounded-3xl bg-gradient-to-r from-blue-950 via-slate-900 to-slate-900 text-white p-6 sm:p-8 flex flex-col sm:flex-row items-center justify-between gap-6 shadow-xl">
              <div className="space-y-1 text-center sm:text-left">
                <h3 className="text-lg sm:text-xl font-black">
                  Need Help Pitching to Corporate CSR Funding Committees?
                </h3>
                <p className="text-xs text-slate-300">
                  Book a confidential 30-minute consultation with our CSR compliance specialists to structure your proposal and verification audit.
                </p>
              </div>
              <button
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-base sm:text-lg font-black">
                    Manage Your Form CSR-1 &amp; Corporate Grants from Your Phone
                  </h3>
                  <p className="text-xs text-slate-400 mt-0.5">
                    Download the Akshay B2B Android app to monitor MCA filings, download approval letters, and connect with CA/CS advisors on the go.
                  </p>
                </div>
              </div>
              <a
