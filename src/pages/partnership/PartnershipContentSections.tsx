          ...
          <table className="w-full text-xs text-left border-collapse">
            ...
            <tbody className="divide-y divide-slate-200">
              <tr className="bg-white">
                ...
                <td className="p-3 text-emerald-800 font-semibold border-r border-slate-200">Officially certified by Registrar of Firms (RoF)</td>
              ...
              <tr className="bg-slate-50">
                ...
                <td className="p-3 text-emerald-800 font-semibold border-r border-slate-200">Full statutory power to sue third parties in court</td>
              ...
              <tr className="bg-slate-50">
                ...
                <td className="p-3 text-emerald-800 font-semibold border-r border-slate-200">Eligible for government e-tenders, GeM, and subsidies</td>
              ...
              <tr className="bg-slate-50">
                ...
                <td className="p-3 text-emerald-800 font-semibold border-r border-slate-200">Superior judicial enforceability among co-partners</td>
          ...
          <table className="w-full text-xs text-left border-collapse">
            ...
            <tbody className="divide-y divide-slate-200">
              ...
              <tr className="bg-slate-50">
                ...
                <td className="p-3 text-emerald-800 font-semibold">Limited to agreed capital contribution</td>
              </tr>
              <tr className="bg-white">
                ...
                <td className="p-3 text-emerald-800 font-semibold">Separate legal juristic person with perpetual succession</td>
              </tr>
              <tr className="bg-slate-50">
              ...
              <tr className="bg-white">
                <td className="p-3 font-bold text-slate-900 border-r border-slate-200">Ease of Formation</td>
                <td className="p-3 text-emerald-800 font-semibold border-r border-slate-200">Extremely simple, fast &amp; cost-effective</td>
              ...
              <tr className="bg-slate-50">
                ...
                <td className="p-3 text-emerald-800 font-semibold border-r border-slate-200">Very low; only ITR-5 and GST returns</td>
          ...
          <table className="w-full text-xs text-left border-collapse">
            ...
            <tbody className="divide-y divide-slate-200">
              ...
              <tr className="bg-slate-50">
                ...
                <td className="p-3 text-emerald-800 font-semibold border-r border-slate-200">Minimal</td>
                <td className="p-3 text-rose-700 font-semibold border-r border-slate-200">High (AOC-4, MGT-7, Audit)</td>
                <td className="p-3 text-emerald-800 font-semibold">Minimal to Zero</td>
              </tr>
              <tr className="bg-white">
                ...
                <td className="p-3 text-emerald-800 font-semibold border-r border-slate-200">Highest (Institutional Grade)</td>
