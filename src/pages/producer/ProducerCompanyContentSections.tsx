  ...
  return (
    <div className="space-y-16 py-6 text-slate-800 text-sm leading-relaxed">
      ...
      <section id="what-is-producer-company" className="scroll-mt-28 space-y-4">
        ...
        <p className="font-bold text-slate-900 bg-emerald-50/60 p-3 rounded-xl border border-emerald-200">
            ...
            <table className="w-full text-xs text-left border-collapse">
              <thead>
                <tr className="bg-emerald-800 text-white">
                  <th className="p-3 font-bold border-r border-emerald-900">Aspect</th>
                  <th className="p-3 font-bold border-r border-emerald-900">Producer Company</th>
              ...
              <tbody className="divide-y divide-slate-200">
                <tr className="bg-white">
                  ...
                  <td className="p-3 text-emerald-800 font-semibold border-r border-slate-200">Companies Act, 2013 / MCA (Central Government)</td>
                ...
                <tr className="bg-slate-50">
                  ...
                  <td className="p-3 text-emerald-800 font-semibold border-r border-slate-200">Autonomous corporate board; minimal state interference</td>
                ...
                <tr className="bg-white">
                  ...
                  <td className="p-3 text-emerald-800 font-semibold border-r border-slate-200">Corporate body with strict limited liability</td>
                ...
                <tr className="bg-slate-50">
                  ...
                  <td className="p-3 text-emerald-800 font-semibold border-r border-slate-200">Pan-India operations without territorial barriers</td>
                ...
                <tr className="bg-slate-50">
                  ...
                  <td className="p-3 text-emerald-800 font-semibold border-r border-slate-200">High access to SFAC equity grants, NABARD &amp; private banks</td>
            ...
            <table className="w-full text-xs text-left border-collapse">
              ...
              <tbody className="divide-y divide-slate-200">
                <tr className="bg-white">
                  ...
                  <td className="p-3 text-emerald-800 font-semibold border-r border-slate-200">Only verified primary agricultural/rural producers</td>
                ...
                <tr className="bg-white">
                  ...
                  <td className="p-3 text-emerald-800 font-semibold border-r border-slate-200">Democratic: 1 Member = 1 Vote</td>
                ...
                <tr className="bg-white">
                  ...
                  <td className="p-3 text-emerald-800 font-semibold border-r border-slate-200">100% deduction under Section 80PA for turnover &lt; ₹100 Cr</td>
        ...
        <div className="space-y-3 pt-1">
          {[
            ...
            <div key={item.step} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
              <div className="w-7 h-7 rounded-lg bg-emerald-800 text-white flex items-center justify-center font-black text-xs flex-shrink-0">
                {item.step}
              </div>
              <div>
                <h4 className="text-xs font-bold text-slate-900">{item.title}</h4>
            ...
            return (
              ...
              >
                <button
                  ...
                  className="w-full text-left p-4 flex items-center justify-between gap-4 font-bold text-xs sm:text-sm text-slate-900 hover:text-emerald-800 transition-colors cursor-pointer"
                >
