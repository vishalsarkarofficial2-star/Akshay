...
export const SoleProprietorshipLanding: React.FC<SoleProprietorshipLandingProps> = ({
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-amber-500 selection:text-white flex flex-col antialiased">
      ...
      <div className="bg-[#0B3D91] text-white text-xs py-2 px-4 border-b border-blue-900/50">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            <span className="bg-[#F5A623] text-[#0B3D91] px-2 py-0.5 rounded text-[10px] font-black uppercase tracking-wider">
              Noida Headquarters
            </span>
            <span className="hidden sm:inline font-medium text-slate-200">
              akshayb2bsolutions — India&apos;s Trusted Legal &amp; Business Registration Partner
            </span>
          </div>
          <div className="flex items-center gap-4 text-xs font-semibold">
            ...
            <button
              ...
              className="text-slate-300 hover:text-white underline text-xs font-bold cursor-pointer"
            >
      ...
      <main className="flex-grow">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <Scale className="w-4 h-4 text-[#F5A623] flex-shrink-0" />
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            ...
                            <div>
                              ...
                              >
                                ...
                                <option value="Standard Package (₹1,999)">Standard Package — ₹1,999 (+ GST + 3M Filings + Trade License)</option>
                                <option value="Premium Package (₹3,499)">Premium All-in-One — ₹3,499 (+ 1Y GST + TM Filing + ISO 9001)</option>
                              </select>
                            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 items-stretch">
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-md hover:shadow-xl transition-all flex flex-col justify-between">
                <div>
                  ...
                  <div className="flex items-center justify-between gap-2 mb-3">
                    ...
                    <span className="px-2.5 py-0.5 rounded bg-amber-100 text-amber-900 text-[10px] font-black uppercase">
                      Instant ₹999 less
                    </span>
                  </div>
                  ...
                  <div className="mb-4 pb-4 border-b border-slate-100">
                    <div className="flex items-baseline gap-2">
                      ...
                      <span className="text-3xl font-extrabold text-[#0B3D91]">₹999</span>
                    </div>
                    <span className="text-[11px] text-slate-500 font-medium block mt-0.5">
                      + Govt. Fee, to be paid later (as per state stamp duty)
                    </span>
                  </div>
              ...
              <div className="bg-white rounded-2xl border-2 border-[#0B3D91] p-6 shadow-xl relative flex flex-col justify-between transform md:-translate-y-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 mb-4">
                    Complete startup setup with GST Certificate &amp; initial quarterly compliance.
                  </p>

                  <div className="mb-4 pb-4 border-b border-slate-100">
                    <div className="flex items-baseline gap-2">
                      <span className="text-sm text-slate-400 line-through">₹3,999</span>
                      <span className="text-3xl font-black text-[#0B3D91]">₹1,999</span>
                    </div>
                    <span className="text-[11px] text-slate-500 font-medium block mt-0.5">
                      + Govt. Fee, to be paid later (as per state stamp duty)
                    </span>
                  ...
                  <div className="space-y-2.5 mb-6">
                    ...
                    {[
                      ...
                      'GST Registration Certificate & 15-digit GSTIN',
                      '3 Months Complete GST Return Filing (GSTR-1 & 3B)',
                      'Shop & Establishment Act / Trade License Filing Guidance',
                      'Official Business Seal & Stamp Design Kit',
                      'Dedicated Chartered Accountant Advisor Assignment'
                    ].map((item, idx) => (
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('Standard Package (₹1,999)');
                    scrollToSection('lead-capture-widget');
                  }}
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-md hover:shadow-xl transition-all flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-xs text-slate-500 mb-4">
                    Full-year umbrella package with tax filing, brand trademark &amp; software.
                  </p>

                  <div className="mb-4 pb-4 border-b border-slate-100">
                    <div className="flex items-baseline gap-2">
                      <span className="text-sm text-slate-400 line-through">₹6,999</span>
                      <span className="text-3xl font-extrabold text-[#0B3D91]">₹3,499</span>
                    </div>
                    <span className="text-[11px] text-slate-500 font-medium block mt-0.5">
                      + Govt. Fee, to be paid later (as per state stamp duty)
                    </span>
                  ...
                  <div className="space-y-2.5 mb-6">
                    ...
                    {[
                      ...
                      '1 Full Year GST Return Filings & Reconciliation',
                      'Trademark (™) Class Search & Filing Assistance',
                      'ISO 9001:2015 Quality Certificate Filing',
                      '1 Year Cloud Invoicing & Billing Software',
                      'Direct Consultation with Senior Partner Advocate'
                    ].map((item, idx) => (
                      <div key={idx} className="flex items-start gap-2 text-xs text-slate-700">
                        <CheckCircle2 className="w-4 h-4 text-emerald-600 flex-shrink-0 mt-0.5" />
                        <span>{item}</span>
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('Premium Package (₹3,499)');
                    scrollToSection('lead-capture-widget');
                  }}
                  className="w-full py-3 rounded-xl bg-slate-900 hover:bg-slate-800 text-white font-bold text-xs shadow-md transition-all cursor-pointer"
                >
              ...
              <table className="w-full text-left text-xs border-collapse min-w-[700px]">
                ...
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-amber-50/60 font-semibold text-emerald-800 border-r border-slate-200">
                      Easiest (4-6 Days)
                    </td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 text-emerald-800 font-semibold">Limited to Share Capital</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 text-emerald-800 font-semibold">Venture Capital, Angel, Equity</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 text-emerald-800 font-semibold">Highest (Global Standards)</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
        ...
        <section className="py-12 bg-white border-b border-slate-200">
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
            <div className="bg-gradient-to-r from-slate-900 to-blue-950 text-white rounded-3xl p-6 sm:p-10 flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden shadow-xl">
              <div className="space-y-4 max-w-md">
                ...
                <div className="flex items-center gap-3 pt-2">
                  <div className="px-4 py-2 bg-white/10 hover:bg-white/20 border border-white/20 rounded-xl flex items-center gap-2 cursor-pointer">
                    <Smartphone className="w-5 h-5 text-[#F5A623]" />
                    <div className="text-left text-[11px] leading-tight">
                      <span className="text-slate-400 block text-[9px]">Available on</span>
                  ...
                  <div className="px-4 py-2 bg-white/10 hover:bg-white/20 border border-white/20 rounded-xl flex items-center gap-2 cursor-pointer">
                    ...
                    <div className="text-left text-[11px] leading-tight">
                      <span className="text-slate-400 block text-[9px]">Download on</span>
              ...
              <div className="w-48 h-48 bg-white/5 border border-white/10 rounded-2xl flex flex-col items-center justify-center p-4 text-center">
                <div className="w-28 h-28 bg-white rounded-lg p-2 flex items-center justify-center mb-2 shadow-inner">
                  <div className="w-full h-full border-2 border-slate-900 border-dashed rounded flex items-center justify-center font-mono font-bold text-slate-900 text-xs">
                    QR CODE
                  </div>
                </div>
                <span className="text-[10px] text-slate-300 font-medium">Scan to Download App</span>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            ...
            <div className="space-y-2.5">
              ...
              <ul className="space-y-1.5 text-slate-400">
                ...
                <li>
                  <button onClick={() => onSelectService('Partnership Firm')} className="hover:text-white transition-colors cursor-pointer">
                    Partnership Firm
                  </button>
                </li>
              </ul>
