...
export function CategoryServiceDetailLanding({
  ...
  return (
    <div id={`page-${service.slug}`} className="min-h-screen bg-slate-50 text-slate-900 font-sans antialiased">
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-[#0c2340] via-[#112d4e] to-[#0f3460] text-white pt-10 pb-16 lg:pt-14 lg:pb-20 overflow-hidden">
        {/* Background Glows */}
              ...
              <div className="bg-white rounded-2xl shadow-2xl p-6 sm:p-8 text-slate-800 border border-slate-100 relative">
                ...
                <div className="text-center pb-5 border-b border-slate-100 mb-5">
                  ...
                  <p className="text-xs text-slate-600 mt-1">
                    Complete package at <span className="font-extrabold text-emerald-700 text-sm">{service.priceDisplay}</span> + Govt Fee
                  </p>
                  {service.urgencyText && (
                ...
                {submitSuccess ? (
                  <div className="text-center py-8 space-y-4">
                    ...
                    <h4 className="text-lg font-bold text-[#0c2340]">Application Received!</h4>
      ...
      <section className="bg-[#0c2340] border-t border-slate-700/80 py-6 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            ...
            <div className="space-y-1 border-l border-slate-700/60 pl-4">
              <div className="text-2xl sm:text-3xl font-extrabold text-emerald-400">15,000+</div>
      ...
      <section className="bg-slate-100 border-b border-slate-200 py-3.5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-12 text-xs font-semibold text-slate-700">
            ...
            <div className="flex items-center gap-2">
              <span className="text-emerald-700 font-extrabold">AmbitionBox</span>
              <div className="flex text-amber-500">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} className="w-3.5 h-3.5 fill-amber-400 text-amber-400" />
                ))}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="hidden lg:block lg:col-span-3">
            <div className="sticky top-24 space-y-6">
              ...
              <div className="bg-gradient-to-br from-[#0c2340] to-[#112d4e] rounded-xl p-5 text-white shadow-md">
                ...
                <div className="space-y-2 text-xs">
                  ...
                  <a
                    ...
                    className="flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 p-2.5 rounded-lg font-bold text-white transition-colors text-center justify-center"
                  >
          ...
          <div className="lg:col-span-9 space-y-14">
                ...
                {service.keyCharacteristics.map((item, idx) => (
                  <div key={idx} className="bg-slate-50 border border-slate-200 rounded-xl p-4.5 space-y-1.5">
                    <div className="flex items-center gap-2">
                      ...
                      <h4 className="text-sm font-bold text-[#0c2340]">{item.title}</h4>
                    </div>
            ...
            <section id="importance-benefits" className="scroll-mt-24 space-y-4 bg-white p-6 sm:p-8 rounded-2xl border border-slate-200 shadow-xs">
              ...
              <div className="space-y-3 pt-2">
                {service.importanceBenefits.benefits.map((b, idx) => (
                  <div key={idx} className="flex items-start gap-3 bg-emerald-50/50 border border-emerald-100 rounded-xl p-3.5">
            ...
            <section id="packages" className="scroll-mt-24 space-y-4 bg-gradient-to-br from-[#0c2340] to-[#112d4e] text-white p-6 sm:p-8 rounded-2xl shadow-md">
                ...
                {service.types.map((tp, idx) => (
                  <div key={idx} className="bg-slate-50 border border-slate-200 rounded-xl p-5 space-y-2">
                    <div className="flex items-center justify-between">
                      <h4 className="text-sm font-bold text-[#0c2340]">{tp.title}</h4>
                      {tp.eligibility && (
            ...
            <section id="laws-governing" className="scroll-mt-24 space-y-4 bg-white p-6 sm:p-8 rounded-2xl border border-slate-200 shadow-xs">
              ...
              <div className="bg-slate-50 p-4 rounded-xl border border-slate-200">
                ...
                <p className="text-sm font-bold text-[#0c2340] mt-0.5">{service.lawsGoverning.actName}</p>
              ...
              <div className="space-y-4 pt-2">
                {service.processSteps.map((st) => (
                  <div key={st.step} className="flex items-start gap-4 bg-slate-50 border border-slate-200 rounded-xl p-4.5">
                    <div className="w-8 h-8 rounded-full bg-[#0c2340] text-amber-400 flex items-center justify-center font-bold text-sm shrink-0">
                      {st.step}
                    </div>
                    <div className="space-y-1">
                      <h4 className="text-sm font-bold text-[#0c2340]">{st.title}</h4>
            ...
            <section id="why-us" className="scroll-mt-24 space-y-6 bg-white p-6 sm:p-8 rounded-2xl border border-slate-200 shadow-xs">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 pt-2">
                <div className="bg-slate-50 border border-slate-200/80 rounded-xl p-4 space-y-2 hover:border-blue-300 transition-colors">
                  ...
                  <h4 className="text-sm font-bold text-[#0c2340]">Expert Legal Guidance</h4>
                ...
                <div className="bg-slate-50 border border-slate-200/80 rounded-xl p-4 space-y-2 hover:border-blue-300 transition-colors">
                  ...
                  <h4 className="text-sm font-bold text-[#0c2340]">Time-Saving Process</h4>
                  <p className="text-xs text-slate-600 leading-relaxed">
                ...
                <div className="bg-slate-50 border border-slate-200/80 rounded-xl p-4 space-y-2 hover:border-blue-300 transition-colors">
                  ...
                  <h4 className="text-sm font-bold text-[#0c2340]">Transparent Pricing</h4>
                  <p className="text-xs text-slate-600 leading-relaxed">
                ...
                <div className="bg-slate-50 border border-slate-200/80 rounded-xl p-4 space-y-2 hover:border-blue-300 transition-colors">
                  ...
                  <h4 className="text-sm font-bold text-[#0c2340]">Trusted by 10,000+</h4>
                  <p className="text-xs text-slate-600 leading-relaxed">
                ...
                <div className="bg-slate-50 border border-slate-200/80 rounded-xl p-4 space-y-2 hover:border-blue-300 transition-colors">
                  ...
                  <h4 className="text-sm font-bold text-[#0c2340]">Compliance Alerts</h4>
                  <p className="text-xs text-slate-600 leading-relaxed">
                ...
                <div className="bg-slate-50 border border-slate-200/80 rounded-xl p-4 space-y-2 hover:border-blue-300 transition-colors">
                  ...
                  <h4 className="text-sm font-bold text-[#0c2340]">Secure & Confidential</h4>
                  <p className="text-xs text-slate-600 leading-relaxed">
            ...
            <section id="faqs" className="scroll-mt-24 space-y-6 bg-white p-6 sm:p-8 rounded-2xl border border-slate-200 shadow-xs">
                  ...
                  return (
                    ...
                    >
                      <button
                        ...
                        className="w-full text-left p-4 bg-slate-50 hover:bg-slate-100/80 font-bold text-xs sm:text-sm text-[#0c2340] flex items-center justify-between gap-3 transition-colors cursor-pointer"
                      >
                        <span>{faq.q}</span>
                        <ChevronDown
              ...
              <div className="bg-gradient-to-r from-[#0c2340] to-[#1a3a60] rounded-2xl p-6 text-white shadow-lg flex flex-col sm:flex-row items-center justify-between gap-6">
                      ...
                      >
                        <div>
                          <div className="flex items-center justify-between gap-1 mb-1">
                            <h4 className="text-xs sm:text-sm font-bold text-[#0c2340] group-hover:text-blue-700 transition-colors">
                              {rs.name}
                            </h4>
      ...
      <div className="fixed bottom-0 inset-x-0 bg-white/95 backdrop-blur-md border-t border-slate-200 py-3 px-4 z-40 shadow-xl">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
          <div className="hidden sm:block">
            ...
            <span className="text-sm font-bold text-[#0c2340] ml-1.5">{service.name}</span>
            <span className="ml-2 text-xs font-extrabold text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded border border-emerald-200">
              {service.priceDisplay} + Govt Fee
            </span>
          </div>
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto justify-end">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 sm:flex-none inline-flex items-center justify-center gap-1.5 bg-emerald-600 hover:bg-emerald-700 text-white text-xs sm:text-sm font-bold py-2.5 px-4 rounded-lg transition-colors"
            >
              <Smartphone className="w-4 h-4" />
