          ...
          <table className="w-full text-xs text-left text-slate-700">
            ...
            <tbody className="divide-y divide-slate-200 bg-white">
              <tr>
                ...
                <td className="p-3 bg-blue-50/50 font-bold text-emerald-700">100% Eligible across all ministries</td>
              ...
              <tr>
                ...
                <td className="p-3 bg-blue-50/50 font-bold text-emerald-700">Mandatory for any active non-profit</td>
