          ...
          <table className="w-full text-xs text-left text-slate-700">
            ...
            <tbody className="divide-y divide-slate-200 bg-white">
              ...
              <tr>
                ...
                <td className="p-3 bg-blue-50/50 font-bold text-emerald-700">Mandatory (General Public)</td>
                <td className="p-3 text-rose-600">No (Family/Individual)</td>
                <td className="p-3 font-bold text-emerald-700">Mandatory</td>
                <td className="p-3 font-bold text-emerald-700">Mandatory</td>
              </tr>
              <tr>
                ...
                <td className="p-3 font-bold text-emerald-700">100% Eligible</td>
                <td className="p-3 font-bold text-emerald-700">100% Eligible</td>
              </tr>
              <tr>
