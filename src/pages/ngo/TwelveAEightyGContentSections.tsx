          ...
          <table className="w-full text-xs text-left text-slate-700">
            ...
            <tbody className="divide-y divide-slate-200 bg-white">
              <tr>
                ...
                <td className="p-3 bg-blue-50/50 font-bold text-emerald-700">Both NGO &amp; Donors</td>
              </tr>
              <tr>
                <td className="p-3 font-semibold text-slate-900">Tax Benefit to NGO</td>
                <td className="p-3 text-emerald-600 font-bold">100% Tax Exemption on Surplus</td>
                <td className="p-3 text-rose-600">None (Full tax applies to surplus)</td>
                <td className="p-3 bg-blue-50/50 font-bold text-emerald-700">100% Tax Exemption</td>
              </tr>
              <tr>
                <td className="p-3 font-semibold text-slate-900">Tax Benefit to Donor</td>
                <td className="p-3 text-slate-500">None</td>
                <td className="p-3 text-emerald-600 font-bold">50% Deduction on taxable income</td>
                <td className="p-3 bg-blue-50/50 font-bold text-emerald-700">50% Deduction on taxable income</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className="p-3 text-slate-500">Partial</td>
                <td className="p-3 bg-blue-50/50 font-bold text-emerald-700">100% Eligible</td>
              </tr>
              <tr>
                <td className="p-3 font-semibold text-slate-900">Recommendation</td>
                <td className="p-3 text-slate-500">Incomplete setup</td>
                <td className="p-3 text-slate-500">Incomplete setup</td>
                <td className="p-3 bg-blue-50/50 font-bold text-emerald-700">Industry Gold Standard</td>
              </tr>
            </tbody>
          </table>
        </div>
