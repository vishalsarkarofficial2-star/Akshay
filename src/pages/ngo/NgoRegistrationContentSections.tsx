            ...
            <table className="w-full text-xs text-left text-slate-600">
              ...
              <tbody className="divide-y divide-slate-200">
                <tr className="hover:bg-slate-50">
                  ...
                  <td className="p-3 text-emerald-700 font-bold">Recognized under Indian Statutory Law</td>
      ...
      <section id="fees" className="scroll-mt-28 space-y-4">
        ...
        <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 space-y-2 text-xs">
          ...
          <div className="flex justify-between items-center pt-1 font-bold text-slate-900">
            ...
            <span className="text-emerald-700">₹0 (Guaranteed Zero Hidden Cost)</span>
          </div>
        </div>
      </section>
